...
5. **Cloud Ready (Google Colab Version)**:
   - Includes `app.ipynb` configured with Google Drive mounts, dependency installation scripts, and Gradio share configuration to easily train on high-performance cloud GPUs.
...
### Tab 4: Hyperparameter Tuning (Optuna)
